/// Containing the implementation of the 'HelpSupport' widget.
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          ExpansionTile(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                    'MoneyMinder categorizes your transactions based on the following categories:'
          ...
          ExpansionTile(
            ...
            children: <Widget>[
              Padding(
                padding: EdgeInsets.all(8.0),
                child: Text(
                    'Navigate to the home page and click on the share icon '
          ...
          ExpansionTile(
            title: Text(
                'Are there any fees associated with using MoneyMinder??',
                style: TextStyle(fontSize: 12.5, color: textColor)),
            children: <Widget>[
              Padding(
                padding: EdgeInsets.all(8.0),
                child: Text(
                    'No there are no fees associated with MoneyMinder! We are an application '
          ...
          ListTile(
            ...
            subtitle: Text(
                'Email: \n\n'
                    ...
                    '\nMansi.patel3@ontariotechu.net'
                    '\nJahanvipareshkumar.mathukia@ontariotechu.net'
                    '\nEthan.randlebragg@ontariotechu.net',
                style: TextStyle(color: textColor)),
            onTap: () {
              // no navigation
            },
