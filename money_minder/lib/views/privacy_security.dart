/// Containing the implementation of the 'PrivacySecurity' widget.
        ...
        children: <Widget>[
          ...
          ListTile(
            title: Text('Terms of Service',
                ...
                TextStyle(fontWeight: FontWeight.bold, color: textColor)),
            subtitle: Text(
                'By using the Money Minder app, you agree to be bound'
          ...
          ListTile(
            title: Text('Data Usage Policy',
                style:
                TextStyle(fontWeight: FontWeight.bold, color: textColor)),
            subtitle: Text(
                'Money Minders Data Usage Policy outlines how we collect, '
